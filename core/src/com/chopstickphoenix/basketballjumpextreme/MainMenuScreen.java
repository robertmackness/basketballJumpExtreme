...
public class MainMenuScreen extends ScreenAdapter {
	...
	public MainMenuScreen (basketballJumpExtreme game) {
		...
		//pre-load an ad
		basketballJumpExtreme.InterfaceAdvertising.loadAdInterstitial();
	...
	public void update () {
		...
		if (Gdx.input.justTouched()) {
			...
			if (swarmLeaderboardBounds.contains(touchPoint.x, touchPoint.y)) {
				...
				basketballJumpExtreme.interfaceSwarm.showSwarmLeaderboard();
	...
	private void beginAdRoll() {
		...
		if (r2 >= 85){ //TODO MACKNESS change R2 >= 1 back to 85
			basketballJumpExtreme.InterfaceAdvertising.showAdInterstitial();
