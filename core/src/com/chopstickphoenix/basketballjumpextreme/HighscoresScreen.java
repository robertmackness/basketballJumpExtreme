...
public class HighscoresScreen extends ScreenAdapter {
	...
	public HighscoresScreen (basketballJumpExtreme game) {
		this.game = game;
	...
	public void update () {
		if (Gdx.input.justTouched()) {
			...
			if (shareBounds.contains(touchPoint.x, touchPoint.y)) {
				Assets.playSound(Assets.clickSound);
				basketballJumpExtreme.interfaceShareGeneral.shareToast();		
		         try{
				...
				basketballJumpExtreme.interfaceShareGeneral.share(fh.toString());
