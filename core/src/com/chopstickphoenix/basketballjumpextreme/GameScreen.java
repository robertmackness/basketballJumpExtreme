...
import com.chopstickphoenix.basketballjumpextreme.World.WorldListener;
...
public class GameScreen extends ScreenAdapter {
	...
	public GameScreen (basketballJumpExtreme game) {
		this.game = game;
	...
	private void updateRunning (float deltaTime) {
		...
		if (world.state == World.WORLD_STATE_GAME_OVER) {
			...
			if (lastScore > Settings.getHighScore() ){
				...
				basketballJumpExtreme.interfaceSwarm.submitSwarmScore();
			}
			Assets.playSound(Assets.hitSound);
